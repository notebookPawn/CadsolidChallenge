...
namespace CadsolidChallenge.Server.Controllers
{
    ...
    public class EquipmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Model,ImagemUrl")] Equipment equipment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Model,ImagemUrl")] Equipment equipment)
        {
            if (id != equipment.Id)
            {
                return NotFound();
